        ...
        $(function () {
            $('#pagination').bootstrapPaginator({
             ...
             /*   pageUrl:function (type, page, current) {
                    return '/front/product/findByParams?pageNum='+page;
                },*/
...
<div id="wrapper">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <form class="form-inline hot-search" action="${pageContext.request.contextPath}/front/product/findByParams" id="frmQuery">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control input-sm" name="productTypeId">
                            ...
                            <option value="${productType.id}" <c:if test="${productParams.productTypeId==productType.id}">selected</c:if>>${productType.name}</option>
                            </c:forEach>
                        </select>
                    </div>
                    &nbsp;
                        ...
                        <div class="panel-body">
                            <div class="art-back clear-back">
                                ...
                                <div class="user clearfix pull-right">
                                    ￥<fmt:formatNumber value="${product.price}" type="number" pattern="#.00"/>
                                </div>
                                <div class="desc">平时穿也不会显得夸张，很大方洋气 我已经自留了，还和小姐妹准备人手一件圣诞节穿着出去玩！ 经典的圆领，大气休闲，长袖设计，休闲舒适 宽松的版型，怕冷可以里面穿保暖衣）
                                </div>
                                <div class="attention pull-right" onclick="addProduct(${product.id})">
