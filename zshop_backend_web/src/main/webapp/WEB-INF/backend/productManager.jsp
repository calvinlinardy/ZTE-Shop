            ...
            $('#frmAddProduct').bootstrapValidator({
                ...
                fields:{
                    name: {//表单元素name的值
                        validators: {//验证规则
                            notEmpty: {
                                message: '商品名称不能为空'//验证失败输出的值
                            },
                            //通过远程请求服务端，校验该产品名称是否已经存在，使用异步调用(ajax)
                            remote:{
...
<div class="modal fade" tabindex="-1" id="delProductModal">
    ...
    <div class="modal-dialog modal-sm">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary delProductType" data-dismiss="modal" onclick="deleteProduct()">确定</button>
                <button class="btn btn-primary cancel" data-dismiss="modal">取消</button>
            </div>
        </div>
    </div>
